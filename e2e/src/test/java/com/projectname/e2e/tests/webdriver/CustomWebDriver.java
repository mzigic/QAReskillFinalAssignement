...
public class CustomWebDriver implements WebDriver, JavascriptExecutor, TakesScreenshot {
    ...
    public CustomWebDriver(WebDriver driver, Duration timeOutInSeconds) {
        this(driver, timeOutInSeconds, StrategyConfig.SLEEP_IN_MILLIS);
    }

    public CustomWebDriver(WebDriver driver, Duration timeOutInSeconds, Duration sleepInMillis) {
        this.driver = driver;
