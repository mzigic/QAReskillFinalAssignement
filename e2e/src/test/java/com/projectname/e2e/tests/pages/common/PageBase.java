...
public abstract class PageBase {
    ...
    private com.projectname.e2e.tests.pages.common.NavigationBarSubPage navigationBarSubPage;
    protected NavigationBarSubPage sandboxNavigationBar;
    ...
    public PageBase(CustomWebDriver driver, String url, String email, String password)
    {
        ...
        this.navigationBarSubPage = new com.projectname.e2e.tests.pages.common.NavigationBarSubPage(driver);
        this.sandboxNavigationBar = new NavigationBarSubPage(driver);
    }
    ...
    public NavigationBarSubPage getNavigationBar() {
        return sandboxNavigationBar;
    }
}
