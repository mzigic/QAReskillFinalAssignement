package com.projectname.api.client.data.model.projects.list;

import java.io.Serializable;
import com.google.gson.annotations.Expose;
import com.google.gson.annotations.SerializedName;

public class ListProjectsResponse implements Serializable
{
    ...
    private final static long serialVersionUID = -6834157675840452341L;

    public ListProjectsResponse() {
    }

    public ListProjectsResponse(Integer id, String title, Integer candidateId, Object image, Integer candidateScenarioId, Integer peopleCount, Integer seniorityCount, Integer technologyCount) {
        super();
        this.id = id;
        this.title = title;
