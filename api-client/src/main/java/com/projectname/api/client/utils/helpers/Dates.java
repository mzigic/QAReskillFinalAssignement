package com.projectname.api.client.utils.helpers;
...
public class Dates {
    ...
    /* To get full list of time zones, use ZoneId.getAvailableZoneIds() */
    public static LocalDateTime getCurrentDateTimeIn(String timeZone) {
